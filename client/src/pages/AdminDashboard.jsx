      ...
      case 'form-submissions':
        return (
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex space-x-2">
                ...
                <button
                  onClick={fetchDbConversions}
                  disabled={dbConversionsLoading}
                  className="bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700 transition-colors disabled:bg-gray-400 flex items-center"
                >
            ...
            <ConversionsTable conversions={dbConversions.filter(conv => conv.source === 'direct')} loading={dbConversionsLoading} />
            
            {/* Pagination Controls */}
            <div className="flex justify-between items-center mt-4">
              <div>
                <span className="text-sm text-gray-600">
                  Showing {dbConversions.filter(conv => conv.source === 'direct').length} entries
                </span>
              </div>
              <div className="flex space-x-2">
                <button
